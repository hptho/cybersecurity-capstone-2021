		...
		<div class="content">
			<form action="register.php" method="post">
				...
				<div class="center">
					...
					<label for="username" style="text-align:left;">Username</label><input type="text" name="username" value="<?php if(isset($_POST['username'])){echo htmlentities($_POST['username'], ENT_QUOTES, 'UTF-8');} ?>" required/><br />
					<label for="email" style="text-align:left;">Email</label><input type="text" name="email" value="<?php if(isset($_POST['email'])){echo htmlentities($_POST['email'], ENT_QUOTES, 'UTF-8');} ?>" required /><br />
